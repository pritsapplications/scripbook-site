...
<link rel="canonical" href="https://pritsapps.com/scripbook/">
...
<meta property="og:url" content="https://pritsapps.com/scripbook/">
...
<meta property="og:image" content="https://pritsapps.com/scripbook/og.png">
...
<meta name="twitter:image" content="https://pritsapps.com/scripbook/og.png">
<style>
...
fs.mkdirSync(new URL("scripbook/", import.meta.url), { recursive: true });
fs.writeFileSync(new URL("scripbook/index.html", import.meta.url), html);
console.log("built scripbook/index.html,", html.length, "bytes");
